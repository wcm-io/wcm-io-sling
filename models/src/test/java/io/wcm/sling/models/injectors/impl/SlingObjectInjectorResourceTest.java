...
public class SlingObjectInjectorResourceTest {
  ...
  public void testResourceResolver() {
    Object result = this.injector.getValue(this.resource, null, ResourceResolver.class, this.annotatedElement, null);
  ...
  public void testRequest() {
    Object result = this.injector.getValue(this.resource, null, SlingHttpServletResponse.class, this.annotatedElement, null);
    assertNull(result);
  }
  ...
  public void testScriptHelper() {
    Object result = this.injector.getValue(this.resource, null, SlingScriptHelper.class, this.annotatedElement, null);
    assertNull(result);
  }
